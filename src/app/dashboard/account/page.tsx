          ...
          {tab === "parametres" && (
            <div>
              <div style={FIELD_STYLE}>
                ...
                <input
                  type="text"
                  value={account?.owner_phone ?? "Non assigné"}
                  disabled
                  style={INPUT_DISABLED}
                  className="atys-input"
                />
                <p style={HELPER_STYLE}>
                  Votre numéro professionnel AtysPro. Les appels de vos clients sont redirigés vers ce numéro.
                </p>
              </div>
              ...
              <div style={{ borderLeft: "3px solid #2563eb", backgroundColor: "#f8fafc", borderRadius: "0 8px 8px 0", padding: "20px 20px 20px 20px", marginTop: "8px" }}>
            ...
            <div>
              ...
              <div style={{ borderTop: "1px solid #f1f5f9", paddingTop: "28px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                  ...
                  {/* Premium */}
                  <div style={{ border: "1px solid #e2e8f0", borderTop: "3px solid #2563eb", borderRadius: "12px", padding: "20px", backgroundColor: "white", position: "relative" }}>
